...
df_nl = pd.read_csv('job_locations_PT.txt', header=None, encoding='ISO-8859-1')
df_nl = process_df(df_nl)

df_irl = pd.read_csv('job_locations_PT.txt', header=None, encoding='ISO-8859-1')
df_irl = process_df(df_irl, 'Ireland')

df_at = pd.read_csv('job_locations_PT.txt', header=None, encoding='ISO-8859-1')
