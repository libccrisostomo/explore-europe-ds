...
for filename in os.listdir(origin_directory):
    ...
    plot_sunburst(df, show=False, save=True, location=filename[filename.rfind('_')+1:filename.rfind('.')],
                  template='plotly', transparent_bg=False)

# Plot with average salary, cost of living, and number of jobs per city
plot_scatter(df_joined_locations, show=False, save=True, min_jobs=25, text=True, template='plotly',
